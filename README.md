...
<p align="justify">
O outro projeto de testes é do tipo xUnit Test Project. Ele utiliza o xUnit para fazer testes unitários, sem ter um Program.cs. Devido a isto, os testes são executados pelo comando dotnet test ou pelo Test Explorer do Visual Studio. Esse projeto faz testes unitários para o método Juros da classe Solucao do projeto DesafioTarget3. São feitos testes para datas antes e após o vencimento. Antes da data de vencimento não há juros, ou seja, o juros é 0.
</p>
